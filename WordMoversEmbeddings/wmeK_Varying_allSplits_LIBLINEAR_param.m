...
param_list = 0.0001:0.00005:0.001;
R = 400;
for jjj = 1:length(filename_list)
    ...
    for jj = 1:length(dataSplit_list)
        ...
        for kkk = 1:length(sample_size_list)
            sample_size = sample_size_list(kkk);
            for j = 1:length(param_list)
                ...
                [trainData, testData, telapsed_fea_gen] = wmeK_GenFea_Nystrom(Data,...
                    ...
                    randdoc_scheme,wordweight_scheme,sample_size, mode);
